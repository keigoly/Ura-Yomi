...
function Billing({ onPurchaseSuccess }: BillingProps) {
  ...
  const plans = [
    { id: 'credits_100', name: '100クレジット', credits: 100, price: 500, description: '解析10回分' },
    { id: 'credits_500', name: '500クレジット', credits: 500, price: 2000, description: '解析50回分（20%割引）' },
    { id: 'subscription_monthly', name: '月額サブスク', credits: 1000, price: 3000, description: '毎月1000クレジット自動付与' },
  ];
          ...
          >
            <div className="flex items-start justify-between mb-2">
              ...
              <div className="text-right">
                <p className="text-lg font-bold text-blue-600">¥{plan.price.toLocaleString()}</p>
