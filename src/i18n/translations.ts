...
const ja = {
  ...
  'auth.description': 'Googleアカウントでサインインして、\nすぐに解析を始めましょう',
  ...
  'auth.freeCredits': '新規登録で20クレジット無料プレゼント！',
  ...
  'side.credits': 'クレジット',
  'side.openYoutube': 'YouTube動画ページを開いてください',
...
const en: Record<keyof typeof ja, string> = {
  ...
  'auth.freeCredits': '20 free credits for new users!',
