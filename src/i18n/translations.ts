...
const ja = {
  ...
  'result.reanalyzeConfirmMessage': 'コメントを再取得しAIで再解析します。{cost}クレジットを消費します。現在の解析結果は上書きされ、元に戻すことはできません。',
...
const en: Record<keyof typeof ja, string> = {
  ...
  'result.reanalyzeConfirmMessage': 'Comments will be re-fetched and re-analyzed by AI. This will cost {cost} credits. The current analysis will be overwritten and cannot be undone.',
